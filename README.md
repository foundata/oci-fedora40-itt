...
[Fedora 40](https://docs.fedoraproject.org/en-US/releases/f40/) (Linux) for integration testing.
...
The sources are available at the [`foundata/oci-fedora40-itt` repository](https://github.com/foundata/oci-fedora40-itt). To build the image locally, do the following:
...
[![REUSE status](https://api.reuse.software/badge/github.com/foundata/oci-fedora40-itt)](https://api.reuse.software/info/github.com/foundata/oci-fedora40-itt)
